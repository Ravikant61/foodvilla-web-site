        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                ...
                <a href="table_reserv.php"><button class="btn btn-primary my-2 my-sm-0" type="submit">Table Reservation</button></a>
              </li>
		  	        <?php
		  				      }
		  	        ?>
            ...
            <form class="form-inline my-2 my-md-0">
              <a href="sellerSignUp.php"><button type="button" class="btn btn-lg btn-block btn-warning"> <i class="fas fa-arrow-circle-right"></i></button></a>
            </form>
        </div>
  </div>
</nav>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
          <div class="card mb-4 box-shadow">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-rupee-sign"></i>. <b><?php echo $res['cost']; ?></b> </p>
...
<footer class="container">
  ...
  <p>Made by Vikash,Ravi,Satayam</p>
</footer>
