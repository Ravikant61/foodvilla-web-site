...
<h3 class="pb-3 mb-4  border-bottom">Table Reservation</h3>
<div class="footer" style="color:red;"><?php if(isset($admin_login_error)){ echo $admin_login_error;}?></div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="username" placeholder="Enter Phone" name="username" required/>
        </div>
        <div class="form-group">
          <label for="username">Date:</label>
          <input type="text" class="form-control" id="username" placeholder="Enter Date" name="username" required/>
        </div>
        <div class="form-group">
          <label for="username">Time:</label>
          <input type="text" class="form-control" id="username" placeholder="Enter Time" name="username" required/>
        </div>
        <div class="form-group">
          <label for="username">No of People:</label>
          <input type="text" class="form-control" id="username" placeholder="Enter No of People" name="username" required/>
        </div>
        <div class="form-group">
          <label for="username">Evant:</label>
          <input type="text" class="form-control" id="username" placeholder="Enter Message" name="username" required/>
        </div>
        <div class="form-group form-check">
          <input type="checkbox" class="form-check-input" id="remember" name="remember" required>
            <label class="form-check-label" for="remember">I agree to the terms and conditions</label>
