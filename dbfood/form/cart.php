...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarsExample07">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item">
						...
						if (!empty($cust_id)) {
							?>
							<a class="navbar-brand" style="color:#1fafdb; text-decoration:none;"><i class="far fa-user"></i>
								Hi! <?php if (isset($cust_id)) {
									echo $qqr['fld_name'];
								} ?></a>
						</li>
						<?php
						...
						if (empty($cust_id)) {
							?>
						<a href="form/index.php?msg=you must be login first"><span style="color:red; font-size:20px;"><i
						...
						<?php
							...
							?>
						<li class="nav-item">
							<a href="cart.php"><span style=" color:green; font-size:20px;"><i class="fa fa-shopping-cart"
										aria-hidden="true"> <span style="color:green;" id="cart"
											class="badge badge-light"><?php if (isset($re)) {
												echo $re;
											} ?></span></i></span></a>
							<a href="../logout.php"><button class="btn btn-success my-2 my-sm-0" type="submit">Log
									Out</button></a>
						</li>
						<?php
						}
				...
				<form class="form-inline my-2 my-md-0">
					<a href="../sellerSignUp.php"><button type="button"
							class="btn btn-lg btn-block btn-primary">FoodVilla Business <i
	...
	<div class="container" style="  padding:60px; border:1px solid #ED2553;">
		...
		<ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ED2553;border-radius:10px 10px 10px 10px;"
			...
			<li class="nav-item">
				<a class="nav-link" style="color:#BDDEFD;" id="manageaccount-tab" data-toggle="tab"
					href="#manageaccount" role="tab" aria-controls="manageaccount" aria-selected="false">Account
					Settings</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" style="color:#BDDEFD;" id="orders-tab" data-toggle="tab" href="#orders" role="tab"
						...
						<tbody>
							...
							if ($re) {
								while ($res = mysqli_fetch_array($query)) {
									...
									<tr>
										<td>
											<image src="../image/restaurant/<?php echo $em . "/foodimages/" . $res['fldimage']; ?>"
								...
								<tr><button type="button" class="btn btn-outline-success"><a href="../index.php"
											style="color:green; text-decoration:none;">No Items In cart Let's Shop
											Now</a></button></tr>
				...
				<form method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="password" name="pswd"
							value="<?php if (isset($fld_password)) {
								echo $fld_password;
							} ?>" class="form-control"
							id="pwd" required />
					</div>
					...
					<button type="submit" name="update" style="background:#ED2553; border:1px solid #ED2553;"
						...
						<tbody>
							...
							while ($roww = mysqli_fetch_array($quer_res)) {
								...
								<tr>
									...
									<td><a href="#" onclick="del(<?php echo $roww['fld_order_id']; ?>);"><button
												type="button" class="btn btn-danger">Cancel Order</button></a></td>
								</tr>
								<?php
							}
							?>
	...
	<footer class="container">
		...
		<p>Made by Vikas,Ravi,satayam</p>
	</footer>
